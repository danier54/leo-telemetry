...
from leo_telemetry.common.satellites import TARGET_SATELLITES
...
_SATELLITE_NAMES = {sat.norad_id: sat.name for sat in TARGET_SATELLITES}
...
TELEMETRY_QUEUE_DEPTH = Gauge(
    ...
    "Pending readings in the demux->observability Redis queue",
    registry=REGISTRY,
)
